...
public enum School {
	...
	GACHON("가천대학교", "gachon"), KANGWON("강원대학교", "kangwon"), KONKUK("건국대학교", "konkuk"), KKU(
		"건국대학교(글로컬)", "kku"),
	GTEC("경기과학기술대학교", "gtec"), KYONGGI("경기대학교", "kyonggi"), KNU("경북대학교", "knu"), GINUE("경인교육대학교",
		"ginue"),
	KHU("경희대학교", "khu"), KAYWON("계원예술대학교", "kaywon"), KOREA("고려대학교", "korea"), KW("광운대학교", "kw"),
	KOOKMIN("국민대학교", "kookmin"), DANKOOK("단국대학교", "dankook"), DUKSUNG("덕성여자대학교", "duksung"), DONGGUK(
		"동국대학교", "dongguk.edu"),
	DONGGUKK("동국대학교(경주)", "wise.dongguk"), DONGDUK("동덕여자대학교", "dongduk"), MJU("명지대학교", "mju"), MJC(
		"명지전문대학교", "mjc"),
	SOGANG("서강대학교", "sogang"), SKUNIV("서경대학교", "skuniv"), SEOULTECH("서울과학기술대학교", "seoultech"), SNUE(
		"서울교육대학교", "snue"),
	SNU("서울대학교", "snu"), UOS("서울시립대학교", "uos"), SWU("서울여자대학교", "swu"), SKKU("성균관대학교", "skku"),
	SUNGSHIN("성신여자대학교", "sungshin"), SJU("세종대학교", "sju"), SOOK("숙명여자대학교", "sookmyung"), SOONG("숭실대학교",
		"soongsil"),
	...
	JBNU("전북대학교", "jbnu"), CAU("중앙대학교", "cau"), CHUNGBUK("충북대학교", "chungbuk"), KNOU("한국방송통신대학교",
		"knou"),
	KPU("한국산업기술대학교", "kpu"), KARTS("한국예술종합대학교", "karts"), HUFS("한국외국어대학교", "hufs"), KNSU("한국체육대학교",
		"knsu"),
	HANYANG("한양대학교", "hanyang"), ERICA("한양대학교(ERICA)", "hanyang"), HONGIK("홍익대학교", "hongik"), DGIST(
		"dgist", "dgist"),
	GIST("gist", "gist"), KAIST("카이스트", "kaist"), POSTECH("포항공과대학교", "postech"), UNIST("unist",
		"unist"),
	...
	ISCU("서울사이버대학교", "iscu"), HYCU("한양사이버대학교", "hycu"), WONKWANG("원광대학교", "wonkwang"), KHCU(
		"경희사이버대학교", "khcu"),
	SDU("서울디지털대학교", "sdu"), BU("백석대학교", "bu"), BC("부천대학교", "bc"), CU("대구가톨릭대학교", "donga"),
	KYWOMAN("한양여자대학교", "kywoman"), HOSEO("호서대학교", "hoseo"), YJC("영진전문대학교", "yjc"), KONGJU("공주대학교",
		"kongju"),
	...
	DONGYANG("동양미래대학교", "dongyang"), DHC("대구보건대학교", "dhc"), YEONSUNG("연성대학교", "yeonsung"), JJ("전주대학교",
		"jj"),
	...
	SANGJI("상지대학교", "sangji"), SSC("수원과학대학교", "ssc"), DONGSEO("동서대학교", "dongseo"), HIT("대전보건대학교",
		"hit"),
	...
	HANSUNG("한성대학교", "hansung"), SYUIN("삼육대학교", "syuin"), KAU("한국항공대학교", "kau"), SEOULARTS("서울예술대학교",
		"seoularts"),
